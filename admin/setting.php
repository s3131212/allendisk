...
echo $config[" sitename "];?>" name="sitename" id="sitename" class="form-control" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value="<?php
echo htmlspecialchars($config[" sitetitle "]);?>" name="sitetitle" id="sitetitle" class="form-control" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value="<?php
echo $config[" size "];?>" name="size" id="size" class="form-control" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value="<?php
echo $config[" total "];?>" name="total" id="total" class="form-control" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value="<?php
echo $config[" url "];?>" name="url" id="url" class="form-control" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value="<?php
echo $config[" subtitle "];?>" name="subtitle" id="subtitle" class="form-control" />
                                </td>
                                <td>顯示在首頁的標語</td>
                            </tr>
                            <tr>
