...
?>
    ...
    <head onselect='return false;'>
        ...
        nav.dir_tree ul li.current>a,
        nav.dir_tree ul li.current>i {
            color: #2196f3
        }
            ...
            <div class="col-md-3">
                <div class="well">
                    <nav class="dir_tree">
                        ...
                        <br/>
                        <li<?php
if ($_GET["dir"] == "0") {echo ' class="current"';}
?>><i class="fa fa-home"></i> <a href="home.php?dir=0" data-id="0" <?php
if ($_GET["dir"] != "0") {echo ' style="color:#444;"';}
?>>主目錄</a>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>檔案大小限制：
                            <?php
echo ($config['size'] != 0) ? sizecount($config["size"]) : "無";?>，當您上傳檔案，代表您已經同意<a href="tos.php" target="_blank">使用條款</a>了，如果您不同意，請勿上傳任何檔案</p>
            ...
            <div class="modal-sm modal-dialog">
				...
				-->
                        <div class="btn-group btn-group-sm btn-group-justified" data-toggle="buttons">
                            <label class="btn btn-default color-tag-btn" id="">
                                <!--default 是白色所以 id 不用設定-->
