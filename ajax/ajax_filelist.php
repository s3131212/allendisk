...
<div class="col-lg-3 col-md-4 col-sm-6">
	<div class="panel" data-id="<?php echo $d['id']; ?>" data-type="dir" data-download-url="home.php?dir=<?php echo $d['id']; ?>">
		<div>
            <div class="panel-body"><i class="fa fa-4x fa-fw fa-folder"></i>
            </div>
			<div class="panel-footer <?php if($d["color"]!="") echo 'tag-'.$d["color"]; ?>">
            ...
            <div class="file-action" style="display: none;">
                ...
                <a href="ajax_recycle_dir.php" data-dir-delete-id="<?php echo $d['id']; ?>" class="btn btn-danger">刪除</a>
                <a href="ajax_rename_dir.php" data-dir-rename-id="<?php echo $d['id']; ?>" class="btn btn-cos">重新命名</a>
                <a href="ajax_move_dir.php" data-dir-move-id="<?php echo $d['id']; ?>" class="btn btn-success">移動</a>
                <?php @sharedir($d['share'],$d["id"]); ?>
                <a href="ajax_set_color" data-dir-color-id="<?php echo $d['id']; ?>" class="btn btn-primary">標記</a>
            </div>
		</div>
	</div>
</div>
...
<div class="col-lg-3 col-md-4 col-sm-6">
	<div class="panel" data-id="<?php echo $d['id']; ?>" data-type="file" data-download-url="downfile.php?id=<?php echo $d['id']; ?>&download=true">
		<div class="panel-body"><?php fileicon($d['type'],$d['name']); ?></i>
		</div>
		<div class="panel-footer<?php if($d["color"]!="") echo ' tag-'.$d["color"]; ?>"><?php echo $d[ 'name']; ?></div>
        <div class="file-action" style="display: none;">
            <?php @sharefile($d['share'],$d["id"],$d["secret"]); ?>
            <?php @linkcheck($d['type'],$d['id'],$d["name"],$d['secret']); ?>
            <a href="ajax_recycle.php" data-delete-id="<?php echo $d['id']; ?>" class="btn btn-danger">刪除</a>
            ...
            <a href="ajax_set_color" data-color-id="<?php echo $d['id']; ?>" class="btn btn-cos">標記</a>
        </div>
	</div>
</div>
<?php }} 
