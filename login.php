...
<style>
	...
	body{background: transparent linear-gradient(to right bottom, #2196F3 0%, #43E3A6 100%) repeat scroll 0% 0%;position:relative}
	h1,p,a{color:#FFF}
	h1{margin:.5em;font-weight:100}
	.panel{background:rgba(255,255,255,.5)}
	label{color:#333}
	.alert{margin:5em 0 1em}
</style>
<script>
    $(function() {
