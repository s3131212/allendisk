...
<div class="container">
    ...
    <?php }else{ ?>
        <ul class="nav nav-tabs">
            <li><a href="index.php">首頁</a></li>
            <li class="active"><a href="#"><?php echo $config["sitename"];?>的好處</a></li>
    ...
    <div>
        ...
        <ul>
            ...
            <li>空間：<?php echo $config["sitename"];?>提供高達<?php sizecount($config["total"]) ?>的空間，且單檔可以達<?php sizecount($config["size"]) ?></p></li>
        </ul>
    </div>
