            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        <td>網頁標題</td>
                        <td>
                            <input type="text" value="" name="sitename" id="sitename" class="form-control" />
                        </td>
                    ...
                    <tr>
                        <td>網頁名稱</td>
                        <td>
                            <input type="text" value="" name="sitetitle" id="sitetitle" class="form-control" />
                        </td>
                    ...
                    <tr>
                        <td>標語</td>
                        <td>
                            <input type="text" value="" name="subtitle" id="subtitle" class="form-control" />
                        </td>
                        <td>顯示在首頁的標語</td>
                    </tr>
                    <tr>
                        <td>啟用註冊功能</td>
                        <td>
                            <input type="checkbox" name="reg" id="reg" value="true" />
                        </td>
                    ...
                    <tr>
                        <td>顯示 「為何選用XXX」</td>
                        <td>
                            <input type="checkbox" name="why" id="why" value="true" />
                        </td>
                    ...
                    <tr>
                        <td>顯示 「使用條款」</td>
                        <td>
                            <input type="checkbox" name="tos" id="tos" value="true" />
                        </td>
                    ...
                    <tr>
                        <td>管理員密碼</td>
                        <td>
                            <input type="text" value="" name="admin" id="admin" class="form-control" />
                        </td>
                        <td>管理介面的密碼</td>
                    </tr>
                </tbody>
