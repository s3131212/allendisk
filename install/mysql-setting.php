    ...
    <form method="post" action="mysql-set.php">
        <table class="table table-hover">
            ...
            <tbody>
                <tr>
                    <td>MySQL 伺服器</td>
                    <td><input type="text" value="localhost" name="host" id="host" class="form-control" /></td>
                ...
                <tr>
                    <td>MySQL 使用者密碼</td>
                    <td><input type="text" value="" name="password" id="password" class="form-control" /></td>
                    <td>MySQL 使用者密碼</td>
                </tr>
                <tr>
                    <td>MySQL 資料庫名稱</td>
                    <td><input type="text" value="" name="dbname" id="dbname" class="form-control" /></td>
                    <td>MySQL 資料庫名稱，請預先新增好此資料庫，安裝程式會自動為您處理資料庫結構</td>
                </tr>
            </tbody>
        </table>
